...
app.registerExtension({
    name: "SaveImageFormatQualityPropertiesSG.display",
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "SaveImageFormatQualityPropertiesSG") {
            const onNodeCreated = nodeType.prototype.onNodeCreated;
            nodeType.prototype.onNodeCreated = function () {
                const r = onNodeCreated ? onNodeCreated.apply(this, arguments) : undefined;
                
                // Set initial minimum width only when first created
                ...
                this.updateWidgetVisibility = function() {
                    ...
                    for (const widget of this.widgets) {
                        ...
                        if (widget.name === "format" || widget.name === "filename_prefix" || widget.name === "display_info" || widget.name === "info") {
                            continue;
                        }
                    ...
                    // Preserve the current width, only adjust height

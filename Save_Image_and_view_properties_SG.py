...
class SaveImageandviewPropertiesSG:
    """Save image with properties view and filename formatting"""
    ...
    def save_and_analyze(self, images, filename_prefix="ComfyUI", format="PNG (lossless, larger files)",
